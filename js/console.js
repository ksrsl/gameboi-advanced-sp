...
import { GameSync, syncConfigFromLocation } from './sync.js?v=4.1.0';
import { setupPointerRelay } from './pointer-relay.js?v=4.1.0';
import { setupLslBridge } from './lsl-bridge.js?v=4.0.1';
import { createArcadeFX } from './arcade-fx.js?v=3.5.0';
import { LeaderboardClient } from './leaderboard.js?v=4.0.3';
import { createLeaderboardUI } from './leaderboard-ui.js?v=4.0.3';
import snakeCartridge from '../games/snake/snake.js?v=4.1.0';
import blockDropCartridge from '../games/block-drop/block-drop.js?v=4.1.0';
import brickBlasterCartridge from '../games/brick-blaster/brick-blaster.js?v=4.1.0';
import astroDefenderCartridge from '../games/astro-defender/astro-defender.js?v=4.1.0';
import petByteCartridge from '../games/pet-byte/pet-byte.js?v=4.1.0';
import byteFlyerCartridge from '../games/byte-flyer/byte-flyer.js?v=3.3.0';
import roadRushCartridge from '../games/road-rush/road-rush.js?v=4.1.0';
import dungeonByteCartridge from '../games/dungeon-byte/dungeon-byte.js?v=4.1.0';
import fishingByteCartridge from '../games/fishing-byte/fishing-byte.js?v=4.1.0';
import mazeMuncherCartridge from '../games/maze-muncher/maze-muncher.js?v=4.1.0';
import miniGolfCartridge from '../games/mini-golf/mini-golf.js?v=4.1.0';
import pocketTennisCartridge from '../games/pocket-tennis/pocket-tennis.js?v=4.1.0';
import pixelKartCartridge from '../games/pixel-kart/pixel-kart.js?v=4.1.0';
import survivorByteCartridge from '../games/survivor-byte/survivor-byte.js?v=4.1.0';
import bombGridCartridge from '../games/bomb-grid/bomb-grid.js?v=4.1.0';
import pixelQuestCartridge from '../games/pixel-quest/pixel-quest.js?v=4.1.0';
import battleTanksCartridge from '../games/battle-tanks/battle-tanks.js?v=4.1.0';
import pocketFighterCartridge from '../games/pocket-fighter/pocket-fighter.js?v=4.1.0';
import streetHoopsCartridge from '../games/street-hoops/street-hoops.js?v=4.1.0';
import pocketBowlingCartridge from '../games/pocket-bowling/pocket-bowling.js?v=4.1.0';
import neonCycleCartridge from '../games/neon-cycle/neon-cycle.js?v=4.1.0';
